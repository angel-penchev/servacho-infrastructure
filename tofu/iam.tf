...
# Each organizational tenant gets a dedicated Resource Pool, IAM User, and automation Token.
# Tokens are pushed directly to Vault, meaning human operators never see them.
#
# Note: Personal infrastructure is managed directly by the root management plane,
# which already has unrestricted administrative access.
# ==============================================================================

# -------------------------------------------------------------
# 1. QOAX COMMUNITY ISOLATION
# -------------------------------------------------------------
...
# -------------------------------------------------------------
# 2. QOAX COMMUNITY BROADCAST ISOLATION
# -------------------------------------------------------------
