...
import {
  to = unifi_device.udm_pro_max
  id = "28:70:4e:5c:b4:b2"
}

import {
  to = unifi_device.usw_aggregation
  id = "1c:6a:1b:98:38:ee"
}

import {
  to = unifi_device.usw_pro_max_24_poe
  id = "9c:05:d6:e2:6b:1d"
}

import {
  to = unifi_device.u7_pro_bedroom
  id = "9c:05:d6:d9:af:65"
}

import {
  to = unifi_device.u7_pro_living_room
